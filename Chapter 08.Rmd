...
This is a multiple regression with  past \emph{errors}
...
$k=1$ if $c\ne0$ and $k=0$ if $c=0$.\vspace*{0.2cm}

Corrected AIC:
\centerline{$\text{AICc} = \text{AIC} + \frac{2(p+q+k+1)(p+q+k+2)}{T-p-q-k-2}.$}\vspace*{0.2cm}
